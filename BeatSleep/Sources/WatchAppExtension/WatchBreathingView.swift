...
struct WatchBreathingView: View {
    ...
    private var stepName: String {
        ...
        switch step.name {
        case "breathing_inhale", "吸气", "Breathe in": return NSLocalizedString("breathe_in", comment: "")
        case "breathing_hold", "屏息", "屏住呼吸", "Hold your breath": return NSLocalizedString("breathe_hold", comment: "")
        case "breathing_exhale", "呼气", "Exhale": return NSLocalizedString("breathe_out", comment: "")
