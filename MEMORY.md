...
- **轻量不打扰** - 功能简单，不做复杂功能
- **温柔提醒** - 不是强制中断，是温和引导
- **系统集成** - 复用 Screen Time, Night Shift 等系统功能
- **隐私保护** - 本地存储用眼数据

### 研究文档

- `EyeCare/docs/06-Research/EYECARE_RESEARCH.md` - 眼疲劳科学调研

### 技术栈

- **框架**: SwiftUI 4.0
- **系统集成**: UserNotifications, HealthKit, WatchConnectivity, Screen Time API
- **主题色**: 绿色 `#22C55E`（护眼、健康）
